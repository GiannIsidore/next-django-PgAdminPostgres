...
const MultiSelector: React.FC<MultiSelectorProps> = ({ options, selectedOptions, onChange, placeholder, emptyIndicator, name }) => {
    ...
    return (
        <div className="relative">
            ...
            {name && <input type="hidden" name={name} value={selectedOptions.map(opt => opt.value).join(',')} />}
        </div>
    );
};
